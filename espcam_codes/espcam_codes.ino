...
const char* ssid = "TRUEVINEAG";
const char* password = "TruevineAG2024";

// Define your MQTT broker details
const char* mqtt_server = "192.168.1.17";// adress sa server
const char* mqtt_topic = "esp32cam/command"; 


// Pin definitions for ESP32-CAM module
...
void captureAndPublishPhoto() {
  ...
  // Publish the photo via MQTT
  client.publish("esp32camphoto", fb->buf, fb->len );
